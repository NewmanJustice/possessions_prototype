# Test Behaviour Matrix — Screen 25: Defendant's Circumstances

## Acceptance Criteria → Test Behaviours

### AC-1: Display defendants' circumstances question

**Behaviour:**
- T-1.1: Page displays question "Is there any information you'd like to provide about the defendants' circumstances?"
- T-1.2: Yes radio option displayed
- T-1.3: No radio option displayed
- T-1.4: Radio options use correct name attribute (`provideDefendantCircumstances`)
- T-1.5: Guidance about financial/personal situation and attempts to obtain details displayed
...
- T-2.2: Error message: "Select whether you want to provide information about the defendants' circumstances"
...
- T-3.2: Textarea labelled "Give details about the defendants' circumstances"
- T-3.3: Textarea uses correct name attribute (`defendantDetails`)
- T-3.4: Character limit guidance displayed ("You can enter up to 950 characters")
...
### AC-6: Persist defendants' circumstances
...
**Behaviour:**
- T-8.1: Clicking Previous redirects to `/claims/claimants-circumstances`
...
**Behaviour:**
- T-9.1: Clicking Continue (valid Yes) redirects to `/claims/alternative-to-possession`
- T-9.2: Clicking Continue (valid No) redirects to `/claims/alternative-to-possession`
...
- T-11.2: Error link targets radio group (`#provideDefendantCircumstances`)
- T-11.3: Error link targets textarea when character limit exceeded (`#defendantDetails`)
...
- T-ERR-1: Radio selection preserved after validation error
- T-ERR-2: Details text preserved after character limit error
...
| Input Preservation | 2 | Cross-cutting |
| **Total** | **54** | **Estimated test count** |
